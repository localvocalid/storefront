  ...
  return (
    <div>
      <div className="small:hidden">
        <div className="text-xl-semi mb-4 px-8">Halo {customer?.first_name}</div>
        <div className="text-base-regular">
          <ul>
            ...
            <li>
              <button className="flex items-center w-full text-rose-500 justify-between py-4 border-b border-gray-200 px-8" onClick={handleLogout} type="button">
                <div className="flex items-center gap-x-2">
